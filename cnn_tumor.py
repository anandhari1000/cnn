...
plt.savefig('tumor_sample_accuracy_plot.png',format='png')
...
plt.savefig('tumor_sample_loss_plot.png',format='png')
...
make_prediction('tumordataset/tumordata/yes/y7.jpg',model)
print("--------------------------------------\n")
make_prediction('tumordataset/tumordata/no/no1.jpg',model)
print("--------------------------------------\n")
